angular.module('MyEmployeeModule')
    .directive('vaEmployeeSelector', ['$q', 'MyEmployeeModule.webApi', function ($q, stores) {
        ...
        return {
            ...
            templateUrl: 'Modules/$(Techment.MyEmployeeModule)/Scripts/directives/vaEmployeeSelector.tpl.html',
